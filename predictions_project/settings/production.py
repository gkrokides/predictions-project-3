"""
Django settings for predictions_project project.
...
SECRET_KEY = '#y!0)b&a9f+*ed5xz%xfr^rqw1kqgxw+5n__z=q_teugdm!q**'
...
ROOT_URLCONF = 'predictions_project.urls'
...
WSGI_APPLICATION = 'predictions_project.wsgi.application'
